            ...
            <form >
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" value="" wire:model="username" name="username"
                    ...
                    <div>
                        <label for="user_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">User
                            Type</label>
                        <select id="user_type" wire:model="user_type"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <p class="mt-1 ml-2 text-sm text-gray-500 dark:text-gray-300" id="avatar_help">SVG, PNG, JPG or
                            GIF (MAX. 800x400px).</p>
                        @error('avatar')
                            <span class="error"> {{ $message }} </span>
                        @enderror
                    ...
                    <button wire:click="save" type="button" data-modal-hide="defaultModal"
