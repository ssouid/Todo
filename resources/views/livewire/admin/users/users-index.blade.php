<div
    class="flex flex-col p-4 bg-white sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="w-full ">
                                ...
                                @forelse($users as $user)
                                    ...
                                    <tr wire:loading.class="opacity-50"
                                        ...
                                        <td class="p-4 space-x-2 whitespace-nowrap">
                                            ...
                                            <button wire:click="showUser({{ $user->id}},'view')" type="button"
                                            ...
                                            <button wire:click="showUser({{$user->id}},'edit')" type="button"
        ...
        @include('livewire.admin.users.modals.new-user-model')
        @include('livewire.admin.users.modals.edit-user-model')
        @include('livewire.admin.users.modals.delete-user-modal')
        @include('livewire.admin.users.modals.user-profile')
    </div>
