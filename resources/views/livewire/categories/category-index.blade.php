<div
    ...
    <div class="w-full ">
        ...
        @include('livewire.categories.modals.new-category-model')
        @include('livewire.categories.modals.edit-category-model')
        @include('livewire.categories.modals.delete-category-modal')
